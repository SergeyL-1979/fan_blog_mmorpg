...
# from mmorpg.models import Respond
...
#     if created:
#         user_id = instance.post.author.pk
#         email_notifying_new_comment.apply_async([instance.id, created, user_id], countdown=5)
#
#
# @receiver(post_save, sender=Respond)
...
#         email_notifying_comment_approved.apply_async([instance.id, created, user_id], countdown=5)
